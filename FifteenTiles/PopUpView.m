...
- (void) createBusyScreen {
    ...
    self.busyIndicatorView.backgroundColor = [[UIColor alloc] initWithRed:0 green:0 blue:0 alpha:0.6];

    self.messageLabel.text = self.messageString;
    self.messageLabel.font = [UIFont systemFontOfSize:self.busyIndicatorView.frame.size.width / 4];
    self.messageLabel.frame = CGRectMake(0, 0, self.busyIndicatorView.frame.size.width - 15, self.busyIndicatorView.frame.size.width / 3);
    ...
    self.messageLabel.textColor = [[UIColor alloc] initWithRed:1 green:1 blue:1 alpha:0.8];
